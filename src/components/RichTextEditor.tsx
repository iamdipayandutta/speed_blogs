...
import { 
  Bold, Italic, Code, Image as ImageIcon, Link, List, ListOrdered, 
  Quote, Heading1, Heading2
} from 'lucide-react';
import katex from 'katex';
import 'katex/dist/katex.min.css';

// Debug log for component loading
console.log("RichTextEditor component file loaded");
...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ 
  ...
  console.log("RichTextEditor component rendering");
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="preview" className="m-0">
          <div className="p-4 h-96 overflow-y-auto">
            {!value ? (
              <p className="text-gray-500 italic">Nothing to preview yet. Start writing in the Write tab.</p>
            ) : (
              <div 
                ref={previewRef}
